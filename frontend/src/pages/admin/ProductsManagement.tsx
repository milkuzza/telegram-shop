...
const ProductsManagement: React.FC = () => {
  ...
  const loadProducts = async () => {
    try {
      ...
      // Response interceptor already extracts .data, so response is the actual data
      const products = response.products || response || [];
      const totalPages = response.totalPages || Math.ceil((response.total || products.length) / 20) || 1;
